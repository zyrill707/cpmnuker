...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan](01): Increase Money             1000K[/bold cyan]")
            console.print("[bold cyan](02): Increase Coins             3.500K[/bold cyan]")
            console.print("[bold cyan](03): King Rank                  4000K[/bold cyan]")
            ...
            console.print("[bold cyan](07): Number Plates             2000K[/bold cyan]")
            ...
            console.print("[bold cyan](12): Unlock all Cars           3000K[/bold cyan]")
            console.print("[bold cyan](13): Unlock all Cars Siren     2000K[/bold cyan]")
            console.print("[bold cyan](14): Unlock w16 Engine       3000K[/bold cyan]")
            console.print("[bold cyan](15): Unlock All Horns         3000K[/bold cyan]")
            console.print("[bold cyan](16): Unlock Disable Damage  2000K[/bold cyan]")
            console.print("[bold cyan](17): Unlock Unlimited Fuel    2000K[/bold cyan]")
            console.print("[bold cyan](18): Unlock House 3          3.500K[/bold cyan]")
            console.print("[bold cyan](19): Unlock Smoke           2000K[/bold cyan]")
            console.print("[bold cyan](20): Change Race Wins      1000K[/bold cyan]")
            console.print("[bold cyan](21): Change Race Loses     1000K[/bold cyan]")
            console.print("[bold cyan](22): Clone Account          5000K[/bold cyan]")
