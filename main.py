    ...
    while True:
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                console.print("[bold cyan][!] Registering new Account.[/bold cyan]")
acc_email = prompt_valid_value("[bold]➤ Account Email[/bold]", "Email", password=False)
acc_password = prompt_valid_value("[bold]➤ Account Password[/bold]", "Password", password=True)  # Note: Password input should be hidden
console.print("[bold cyan][%] Creating new Account[/bold cyan]: ", end=None)

# Assuming you have a method named `account_register` in your `CPMNuker` class
status = cpm.account_register(acc_email, acc_password)
